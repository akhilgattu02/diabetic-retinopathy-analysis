...
class IDRiDDatasetBuilder:
    ...
    def return_image_abnormality(self, dataset_type, abnormal_path, ab, h, w):
        if dataset_type == "train":
            msk_root = "data/raw/A. Segmentation/2. All Segmentation Groundtruths/a. Training Set/"
        
        else:
            msk_root = "data/raw/A. Segmentation/2. All Segmentation Groundtruths/b. Testing Set/"
    ...
    def create_dataset(self, dataset_type):
        ...
        if dataset_type == "train":
            root = "data/raw/A. Segmentation/1. Original Images/a. Training Set/"
        else:
            root = "data/raw/A. Segmentation/1. Original Images/b. Testing Set/"

        img_root = "data/processed"
        dir = os.listdir(root)
        dir.sort()

        if dataset_type not in os.listdir("/Users/akhilgattu/Desktop/diabetic-retinopathy-analysis/"+img_root):
        ...
        for fol in dir:
            ...
            imgs = f"/Users/akhilgattu/Desktop/diabetic-retinopathy-analysis/{img_root}/{dataset_type}/images/{fol}"
            masks = f"/Users/akhilgattu/Desktop/diabetic-retinopathy-analysis/{img_root}/{dataset_type}/masks/{img_name}.tif"
